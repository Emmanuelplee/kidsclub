            ...
            <div class="card-header">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="text-center">
                                <img src="/images/Manualidades/Escolares/antorcha.jpg" class="rounded-circle" alt="" width="180" height="180">
                                <p style="margin-bottom: 0px">Antorcha</p>
                                <a class="btn btn-primary" href="{{ route('manualidad.escolar.antorcha') }}" role="button">Comenzamos</a>
                                <hr>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="text-center">
                                <img src="/images/Manualidades/Escolares/comedero.jpg" class="rounded-circle" alt="" width="180" height="180">
                                <p style="margin-bottom: 0px">Comedero</p>
                                <a class="btn btn-primary" href="{{ route('manualidad.escolar.comedero') }}" role="button">Comenzamos</a>
                                <hr>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="text-center">
                                <img src="/images/Manualidades/Escolares/dedogoma.jpg" class="rounded-circle" alt="" width="180" height="180">
                                <p style="margin-bottom: 0px">Dedo goma</p>
                                <a class="btn btn-primary" href="{{ route('manualidad.escolar.dedogoma') }}" role="button">Comenzamos</a>
                                <hr>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="text-center">
                                <img src="/images/Manualidades/Escolares/instrumentos.jpg" class="rounded-circle" alt="" width="180" height="180">
                                <p style="margin-bottom: 0px">Instrumentos</p>
                                <a class="btn btn-primary" href="{{ route('manualidad.escolar.instrumento') }}" role="button">Comenzamos</a>
                                <hr>
                            </div>
                        </div>
                    </div>
