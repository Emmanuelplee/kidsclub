...
Route::get('/manualidades/escolares/antorcha','ManualidadesControler@antorcha')->name('manualidad.escolar.antorcha');
Route::get('/manualidades/escolares/comedero','ManualidadesControler@comedero')->name('manualidad.escolar.comedero');
Route::get('/manualidades/escolares/dedogoma','ManualidadesControler@dedogoma')->name('manualidad.escolar.dedogoma');
Route::get('/manualidades/escolares/instrumento','ManualidadesControler@instrumento')->name('manualidad.escolar.instrumento');
